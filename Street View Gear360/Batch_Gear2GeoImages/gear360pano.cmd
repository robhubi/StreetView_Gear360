...
set start=%time%
set HUGINPATH=F:\Program Files\Hugin\bin
set HUGINPATH32=F:\Program Files (x86)\Hugin\bin
set GALLERYDIR=html
...
set MULTIBLENDEXE=multiblend\multiblend.exe
...
if "%BLENDPROG%" == "multiblend\multiblend.exe" (
